...
class PrizesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prize" do
    assert_difference('Prize.count') do
      post prizes_url, params: { prize: { event_id: @prize.event_id, name: @prize.name, place: @prize.place } }
    end
  ...
  test "should update prize" do
    patch prize_url(@prize), params: { prize: { event_id: @prize.event_id, name: @prize.name, place: @prize.place } }
