...
class PlayerEventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create player_event" do
    assert_difference('PlayerEvent.count') do
      post player_events_url, params: { player_event: { event_id: @player_event.event_id, player_id: @player_event.player_id, prize_id: @player_event.prize_id } }
    end
  ...
  test "should update player_event" do
    patch player_event_url(@player_event), params: { player_event: { event_id: @player_event.event_id, player_id: @player_event.player_id, prize_id: @player_event.prize_id } }
